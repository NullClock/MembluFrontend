...
function loginWithExotek() {
  const webmodal = webModal(`https://exotek.co/login?client_id=64cd495c5e5d4fb36411c588&redirect_uri=${window.location.protocol.replace(":", "")}%3A%2F%2F${window.location.host}&response_type=code&scope=userinfo&state=OPTIONAL`, "Login with Exotek", "1500", "1500");
